...
import { useGetProductByIdQuery, useReviewProductsMutation } from "../slices/productApiSlice";
    ...
    <>
      {isLoading ? (
        ...
        <>
          ...
          <Row>
            <Col md={5}>
              <Image src={`https://ecommerce-app-mern-1121.onrender.com${product.image}`} alt={product?.name} fluid />
            </Col>
            <Col md={4}>
